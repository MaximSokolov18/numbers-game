    ...
    return (
        <div className="flex flex-col justify-center items-center h-screen w-screen">
            <p className="px-10 text-justify mb-10 md:max-w-[765px]">
                Test your skills and challenge your mind with Numbers Game! Enjoy a fun, interactive experience that
                combines strategy and quick thinking. Whether you're sharpening your math abilities or simply looking
